...
-- texture_sets defined in levels/themes/texture_sets.lua
-- include {TETRIS, MISHMASH, TROM, MINESWEEPER, GO, PACKMAN, INVISIBLEWALLS, INVISIBLE_WALLS, CUSTOMIZABLE_FLOORS, CAPTURE_THE_FLAG,
...
function api:init(params)
  ...
  api._map = make_map.makeMap{
      ...
      mapEntityLayer = SIMPLE_TEXT_MAP,
      useSkybox = false,
      textureSet = texture_sets.KNOWLEDGE
  }
end
